...
export default function ContactPage() {
  ...
  const { supportEmail, supportTelegram, supportFacebook } = useSettingsStore()
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="game-card p-6">
            ...
            <a href={`mailto:${supportEmail}`} className="btn-neon-green w-full py-2.5 text-sm flex items-center justify-center gap-2">
          ...
          <div className="game-card p-6">
            ...
            <a href={supportTelegram} target="_blank" rel="noreferrer" className="w-full py-2.5 px-4 rounded-xl border border-blue-500 bg-blue-500/20 text-blue-400 font-bold hover:bg-blue-500/30 transition-all flex items-center justify-center gap-2 text-sm">
          ...
          <div className="game-card p-6">
            ...
            <a href={supportFacebook} target="_blank" rel="noreferrer" className="w-full py-2.5 px-4 rounded-xl border border-blue-600 bg-blue-600/20 text-blue-500 font-bold hover:bg-blue-600/30 transition-all flex items-center justify-center gap-2 text-sm">
